...
* group[=].element[=].target.code = #Composition.sectionOrderInformation.entry.ofType(CZ_ImagingOrderInformation)
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #CZ_ImagingOrderInformation.identifier
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #CZ_ImagingOrderInformation.dateTime
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #CZ_ImagingOrderInformation.requestedExecdateTime
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #CZ_ImagingOrderInformation.urgency
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #CZ_ImagingOrderInformation.orderText
...
* group[=].element[=].target.code = #Composition.sectionOrderInformation.entry.ofType(CZ_ImagingOrderInformation).reasonReference.ofType(ConditionImage)
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #ConditionImage.coding
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.code = #ConditionImage.text
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto	
* group[=].element[=].target.comment = "Composition.section:sectionEncounter.entry.ofType(CZ_Encounter)"	
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto	
* group[=].element[=].target.comment = "Composition.section:sectionSpecimen.entry.ofType(CZ_Specimen)"
...
* group[=].element[=].target.code = #Composition.sectionOrderInformation.order.supportingInfo.ofType(CZ_ObservationImage)			
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[+].source = "https://hl7.cz/fhir/img-order/StructureDefinition/ImageSupportingInformationCz"
...
* group[=].element[=].target.code = #Composition.sectionOrderInformation.order.supportingInfo.ofType(CZ_BodyWeight)		
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
...
* group[=].element[=].target.code = #Composition.sectionOrderInformation.order.supportingInfo.ofType(CZ_BodyHeight)				
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
...
* group[=].element[=].target.code = #Composition.sectionOrderInformation.order.supportingInfo.ofType(CZ_ConditionImage)		
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Body.SupportingInformation.otherRelevantClinicalInformation.text
...
* group[=].element[=].target.code = #Composition.sectionOrderInformation.order.supportingInfo.ofType(CZ_MedicationStatement)			
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
...
* group[=].element[=].target.code = #Composition.sectionOrderInformation.order.supportingInfo.ofType(CZ_AllergyIntolerance)			
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto					
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto
* group[=].element[+].code = #Body.SupportingInformation.limitationOfPatientMobility.code
* group[=].element[=].display = "A.3.1.5.1 - Code"
* group[=].element[=].target.code = #CZ_ObservationImage.code.coding
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #equivalent
* group[=].element[+].code = #Body.SupportingInformation.limitationOfPatientMobility.text
...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto					
* group[=].element[=].target.comment = "Composition.section:sectionOrderInformation.entry.ofType(CZ_ImagingOrderInformation)"
