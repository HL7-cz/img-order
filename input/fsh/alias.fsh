...
Alias: $dicomwithoutversion = http://dicom.nema.org/resources/ontology/DCM
...
Alias: $drzar = https://ncez.mzcr.cz/fhir/CodeSystem/drzar
...
Alias: $mkn10vs = https://terminology.uzis.cz/ValueSet/Mkn10_5
...
Alias: $targetBodyStructure = http://hl7.org/fhir/StructureDefinition/procedure-targetBodyStructure
