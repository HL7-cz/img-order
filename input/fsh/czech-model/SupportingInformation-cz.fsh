...
*  mozneKontraindikaceVlivemMedikaci 0..* Base "A.3.1.3 - Možné kontraindikace vyšetření nebo podání kontrastní látky" """Blok medikace obsahující informace o medikaci mající vliv na průběh či výsledek vyšetření či jeho interpretaci."""
*  mozneKontraindikaceVlivemMedikaci.medikace 0..* Base "A.3.1.3.1 - Medikace" """Blok medikace obsahující informace o medikaci mající vliv na průběh či výsledek vyšetření či jeho interpretaci."""
*  mozneKontraindikaceVlivemMedikaci.medikace.id 0..* Identifier "A.3.1.3.1.1 - ID medikace" """ID medikace"""
*  mozneKontraindikaceVlivemMedikaci.medikace.kod 0..* code "A.3.1.3.1.2 - Kod medikace" """Kod medikace"""
*  mozneKontraindikaceVlivemMedikaci.medikace.mnozstvi 0..1 Ratio "A.3.1.3.1.3 - Mnozstvi" """Mnozstvi medikace"""
