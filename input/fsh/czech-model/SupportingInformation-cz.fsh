...
*  biometrickaData.vaha.datumACas  1..1 dateTime "A.3.1.1.1.3 - Datum" """Datum zjištění údaje, uvádí se, pokud je odlišné od data vystavení objednávky."""
...
*  mozneKontraindikaceVlivemMedikaci.medikace.kod 0..* CodeableConcept "A.3.1.3.1.2 - Kod medikace" """Kod medikace"""
