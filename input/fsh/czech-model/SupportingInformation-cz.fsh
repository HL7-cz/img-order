...
*  mozneKontraindikace 0..* Base "A.3.1.3 - Možné kontraindikace vyšetření nebo podání k.l." """vyjma alergie a varování které jsou v sekci níže"""
*  mozneKontraindikace.medikace 0..* Base "A.3.1.3.1 - Medikace" """Blok medikace obsahující informace o medikaci mající vliv na průběh či výsledek vyšetření či jeho interpretaci."""
*  mozneKontraindikace.medikace.id 0..* Identifier "A.3.1.3.1.1 - ID medikace" """ID medikace"""
*  mozneKontraindikace.medikace.kod 0..* code "A.3.1.3.1.2 - Kod medikace" """Kod medikace"""
*  mozneKontraindikace.medikace.mnozstvi 0..1 Ratio "A.3.1.3.1.3 - Mnozstvi" """Mnozstvi medikace"""
