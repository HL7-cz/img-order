...
* telo 1..1 logBodyImageOrderCz "A.2 a A.3 - Tělo žádanky obrazového vyšetření" """Tělo žádanky obrazového vyšetření"""
* presentacniForma 0..* logPresentedFormCz "A.4 - Vizuální podoba dokumentu" """Žádanka obrazového vyšetření čitelná lidským okem,  je požadován PDF formát."""
