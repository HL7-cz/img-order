...
* adresa 0..* Base "A.1.5.3 - Kontaktní údaje zadavatele objednávky" """Kontaktní údaje zadavatele objednávky (adresa a telekomunikační údaje)."""
* organizace 1..1 Base "A.1.5.4 - Organizace zadavatele objednávky" """Organizace zadavatele objednávky (poskytovatel zdravotních služeb)."""
