...
* body 1..1 BodyImageOrderCz "A.2 a A.3 - Imaging Order body data element" """Imaging Order body data element"""
* presentedForm 0..* PresentedFormCz "A.4 - Presented Form" """Entire order as issued. Various formats could be provided,  pdf format is recommended."""
